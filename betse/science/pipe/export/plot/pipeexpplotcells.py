...
class SimPipeExportPlotCells(SimPipeExportPlotABC):
    ...
    **Post-simulation cell cluster plot pipeline** (i.e., object iteratively
    ...
    def export_voltage_polarity(
        ...
        pcx = phase.cells.convert_mems_to_cells(polx * phase.cells.mem_sa) / phase.cells.cell_sa
        pcy = phase.cells.convert_mems_to_cells(poly * phase.cells.mem_sa) / phase.cells.cell_sa
